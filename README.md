...
* [🚦Como iniciar com o Git?](#how-to-start-using-gpt-pilot)
...
- **O que é o Git?**
O Git é um sistema de controle de versão popular. Foi criado por Linus Torvalds em Desde então, e tem sido mantido por Junio Hamano.
- **É usado para:**     
- Rastreamento de alterações de código
- Rastreamento de quem fez mudanças
- Colaboração de codificação
- **O que o Git faz?**
- Gerencie projetos com repositórios
- Clone um projeto para trabalhar em uma cópia local
- Controle e rastreamento com Staging e Committing (em inglês)
- Crie Branchs (ramos) para permitir o trabalho diferentes partes e versões de um projeto
- Puxe a versão mais recente do projeto para uma cópia local
- Pressione as atualizações locais para o projeto principal
-**Trabalhando com o Git**
- Inicialize o Git em uma pasta, tornando-se um repositório
...
- Você seleciona os arquivos modificados que deseja para Stage
- Os Stagedarquivos encetificados são comprometidos, que solicita o Git para armazenar um instantâneo permanente dos arquivos
- O Git permite que você veja a história completa de cada commit.
- Você pode voltar a qualquer commit anterior.
- O Git não armazena uma cópia separada de cada arquivo em cada commit, mas Acompanhe as mudanças feitas em cada commit!
-**Por que o Git?**
- Mais de 70% dos desenvolvedores usam o Git!
- Os desenvolvedores podem trabalhar juntos em qualquer lugar do mundo.
- Os desenvolvedores podem ver toda a história do projeto.
- Os desenvolvedores podem reverter para versões anteriores de um projeto.
-**O que é o GitHub?**
- O Git não é o mesmo que o GitHub.
- O GitHub faz ferramentas que usam o Git.
- O GitHub é o maior hospedeiro de código-fonte do mundo e foi possuído por pela Microsoft desde 2018.
- Neste tutorial, vamos nos concentrar em usar o Git com o GitHub.

# 🚦Como iniciar com o Git?
-**Instalar do Git**
- Você pode baixar o Git gratuitamente no seguinte site: https://www.git-scm.com/
-**Usando Git com linha de comando**
1. Para começar a usar o Git, vamos primeiro abrir nosso shell de Comando. Para o Windows, você pode usar o Git bash, que vem incluído no Git para Windows. Para Mac e Linux você pode usar o terminal interno.
2. Após a instalação precisamos verificar se o Git está instalado corretamente com o seguinte comando: `git --version`. A saída para este comando deve ser algo como: `git version 2.30.2.windows.1`.
- Se o Git estiver instalado, ele deve mostrar algo como git version X.Y.
-**Configurar o Git**
